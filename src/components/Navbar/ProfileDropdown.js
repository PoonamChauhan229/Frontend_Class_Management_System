...
const ProfileDropdown = ({linkredirect5,linkredirect6,linkredirect4,linkredirect3,linkredirect2,linkredirect1,first,second,third,fourth,fifth,sixth,seventh}) => {
    ...
    <div className="bg-white py-2 collapse-inner rounded">
        <Link className="collapse-item" to={"/"+linkredirect1}> <i className="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>{first}</Link>
        <div className="dropdown-divider"></div>
        <Link className="collapse-item" to={"/"+linkredirect2}> <i className="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>{second}</Link>
